...
export const EnhancedSEO = ({
  ...
  canonical,
  image = "https://fazendafundamento.agroarkafla.com/assets/images/agro-arkafla-castro-fazenda-de-agrtonegocios-2000x1079.png",
  type = "website",
  schemaData
}: EnhancedSEOProps) => {
  ...
  return (
    <Helmet>
      ...
      <link rel="preconnect" href="https://agroarkafla.com" />
