        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-6">
              ...
              <a 
                href="https://api.whatsapp.com/send?phone=5542999586858&text=Olá! Vi seu site e gostaria de mais informações sobre a Agro Arkafla. (Vindo da Seção Instagram)" 
                target="_blank"
                rel="noreferrer"
