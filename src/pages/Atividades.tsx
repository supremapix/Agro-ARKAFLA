  ...
  const atividades = [
    {
      ...
      image: "https://fazendafundamento.agroarkafla.com/assets/images/foto-colheita-trigo-254x191.jpg",
    ...
    },
    {
      ...
      image: "https://fazendafundamento.agroarkafla.com/assets/images/agro-gado-holandes-castro-pr-castro-fazenda-de-gado-794x523.png",
    ...
    },
    {
      ...
      image: "https://fazendafundamento.agroarkafla.com/assets/images/agro-arkafla-silvicultura-1-183x217.jpg",
      ...
      <div className="container mx-auto px-4">
        ...
        <section id="silagem" className="mt-32 bg-agri-dark text-white rounded-[4rem] overflow-hidden shadow-2xl">
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="lg:w-1/2 relative">
              <img 
                src="https://fazendafundamento.agroarkafla.com/assets/images/agro-arkafla-castro-pr-castro-silagem-pre-secada-1-794x523.png" 
        ...
        <section className="mt-24 bg-white rounded-[3rem] p-12 md:p-20 shadow-xl border border-gray-100">
          <div className="flex flex-col lg:flex-row-reverse gap-16 items-center">
            ...
            <div className="lg:w-1/2">
              <img 
                src="https://fazendafundamento.agroarkafla.com/assets/images/silagem-pr-secada-embalada-254x165.jpg" 
